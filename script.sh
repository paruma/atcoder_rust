...
alias ojt="python3 ${_ATCODER_ROOT}/atcoder_tool.py test"
alias ojs="python3 ${_ATCODER_ROOT}/atcoder_tool.py submit"
alias exe="python3 ${_ATCODER_ROOT}/atcoder_tool.py exe"
