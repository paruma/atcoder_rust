            ...
            for &d in &dir {
                ...
                loop {
                    ...
                    if self.is_ice(next_pos) {
                        moving_pos = next_pos;
                        visited_all[moving_pos.y as usize][moving_pos.x as usize] = true;
                    } else {
                        //岩
                        break;
                    }
                ...
                // 岩にぶつかるまで移動した
                if !visited_stop[moving_pos.y as usize][moving_pos.x as usize] {
                    visited_stop[moving_pos.y as usize][moving_pos.x as usize] = true;
