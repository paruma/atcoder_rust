...
pub mod two_sequence_range_affine_range_sum_of_quadratic {
        ...
        T: Copy + Mul<Output = T> + Add<Output = T> + From<i64>,
    {
        ...
        fn mapping(
            f: &Self::F,
            data: &TwoSequenceQuadraticData<T>,
        ) -> TwoSequenceQuadraticData<T> {
            let a = f.a;
            let b = f.b;
            let c = f.c;
            let d = f.d;
