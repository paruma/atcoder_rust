...
pub mod range_xor_apply_range_xor {
        ...
        T: Copy + BitXor<Output = T> + From<u8>,
    {
        ...
        type F = Option<T>; // None means no XOR application, Some(val) means XOR with val
    ...
    where
        T: Copy + BitXor<Output = T> + From<u8>,
    {
        pub fn new(xs: &[T]) -> RangeXorApplyRangeXorSegtree<T> {
...
pub mod test_range_xor_apply_range_xor {
    ...
    fn test_new_and_get() {
        ...
        let mut segtree = RangeXorApplyRangeXorSegtree::<u64>::new(&xs);
    ...
    fn test_random_update() {
        ...
        for _ in 0..100 {
            ...
            let mut segtree = RangeXorApplyRangeXorSegtree::<u64>::new(&naive_vec);
