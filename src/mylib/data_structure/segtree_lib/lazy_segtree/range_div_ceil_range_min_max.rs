...
pub mod range_div_ceil_range_min_max {
    ...
    impl RangeDivCeilRangeMinMaxSegtree {
        ...
        pub fn range_min_max<R>(&mut self, range: R) -> RangeMinMax
        where
            R: RangeBounds<usize>,
        {
        ...
        pub fn all_min_max(&self) -> RangeMinMax {
...
mod test_range_div_ceil_range_min_max {
    ...
    fn test_range_min_max() {
        ...
        let mut segtree = RangeDivCeilRangeMinMaxSegtree::new(&xs);
        assert_eq!(
            segtree.range_min_max(1..4),
            RangeMinMax { min: 30, max: 50 }
        );
        assert_eq!(
            segtree.range_min_max(2..5),
            RangeMinMax { min: 20, max: 40 }
        );
    }
    ...
    fn test_apply_range_div_ceil() {
        ...
        assert_eq!(segtree.range_min_max(1..4), RangeMinMax { min: 7, max: 14 });
    }
    ...
    fn test_negative_values() {
        ...
        assert_eq!(segtree.range_min_max(0..5), RangeMinMax { min: -5, max: 5 });
    }
