...
pub mod range_div_floor_range_max {
    ...
    impl RangeDivFloorRangeMaxSegtree {
        pub fn new(xs: &[i64]) -> RangeDivFloorRangeMaxSegtree {
            let len = xs.len();
...
mod test_range_div_floor_range_max {
    ...
    fn test_new_and_get() {
        ...
        let mut segtree = RangeDivFloorRangeMaxSegtree::new(&xs);
    ...
    fn test_random_div_max() {
        ...
        for _ in 0..100 {
            ...
            let mut segtree = RangeDivFloorRangeMaxSegtree::new(&naive_vec);
