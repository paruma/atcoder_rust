use crate::data_structure::fenwick_tree::rect_sum_fenwick_tree_2d::rect_sum_fenwick_tree_2d::RectSumFenwickTree2DArbitrary;
...
mod tests {
    ...
    fn test_rect_add_fenwick_tree_2d_basic() {
        ...
        assert_eq!(ft.len_h(), 4);
        assert_eq!(ft.len_w(), 4);
