...
### 3.6. 構造化された Docstring
- 全ての関数に Docstring を記述すること。
- 特に、引数と戻り値の説明を明記すること。

### 3.7. 副作用の分離

副作用のない関数を作る、副作用を隔離する。Haskell のイメージで。
