...
- ライブラリコードの編集をしたら以下を行ってください
    ...
    - 意図しない差分が出ていないかを git diff コマンドで確認してください。ただし、まったく関係ないファイルに変更があった場合はユーザが編集している可能性があるので、ユーザに確認を取ってください
ください。
...
- 競技プログラミングにおいて、計算量はとても大事です。計算量が違うものは同じ機能であっても別物という扱いになります。
